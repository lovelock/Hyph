...
ZEPHIR_INIT_CLASS(Hyph_Container_Container) {

	ZEPHIR_REGISTER_CLASS(Hyph\\Container, Container, hyph, container_container, hyph_container_container_method_entry, 0);

	zend_declare_property_null(hyph_container_container_ce, SL("services"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(hyph_container_container_ce, SL("serviceStore"), ZEND_ACC_PRIVATE TSRMLS_CC);

	return SUCCESS;

}

PHP_METHOD(Hyph_Container_Container, __construct) {
...
PHP_METHOD(Hyph_Container_Container, __get) {
...
PHP_METHOD(Hyph_Container_Container, has) {
...
PHP_METHOD(Hyph_Container_Container, get) {
	...
	if (!zephir_is_true(&_0)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "hyph/Container/Container.zep", 33 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	zephir_array_fetch(&_6, &_5, &name, PH_NOISY | PH_READONLY, "hyph/Container/Container.zep", 40 TSRMLS_CC);
	RETURN_CTOR(_6);

}

PHP_METHOD(Hyph_Container_Container, createService) {
	...
	zephir_array_fetch(&entry, &_0, &name, PH_NOISY, "hyph/Container/Container.zep", 46 TSRMLS_CC);
	_1 = !(Z_TYPE_P(&entry) == IS_ARRAY);
	if (!(_1)) {
		_1 = !(zephir_array_isset_string(&entry, SL("class")));
	}
	zephir_array_fetch_string(&_2, &entry, SL("class"), PH_NOISY | PH_READONLY, "hyph/Container/Container.zep", 49 TSRMLS_CC);
	if (_1) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_3$$3, "hyph/Container/Container.zep", 48 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	} else if (!(zephir_class_exists(&_2, 1 TSRMLS_CC))) {
		ZEPHIR_INIT_VAR(&_5$$4);
		object_init_ex(&_5$$4, hyph_exception_containerexception_ce);
		zephir_array_fetch_string(&_6$$4, &entry, SL("class"), PH_NOISY | PH_READONLY, "hyph/Container/Container.zep", 50 TSRMLS_CC);
		ZEPHIR_INIT_VAR(&_7$$4);
		ZEPHIR_CONCAT_VSV(&_7$$4, &name, " service does not exist: ", &_6$$4);
		ZEPHIR_CALL_METHOD(NULL, &_5$$4, "__construct", NULL, 1, &_7$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_5$$4, "hyph/Container/Container.zep", 50 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (zephir_array_isset_string(&entry, SL("arguments"))) {
		zephir_array_fetch_string(&_8, &entry, SL("arguments"), PH_NOISY | PH_READONLY, "hyph/Container/Container.zep", 59 TSRMLS_CC);
	...
	zephir_array_fetch_string(&_9, &entry, SL("class"), PH_NOISY | PH_READONLY, "hyph/Container/Container.zep", 61 TSRMLS_CC);
...
PHP_METHOD(Hyph_Container_Container, resolveArguments) {
	...
	array_init(&arguments);
	zephir_is_iterable(&argumentDefinitions, 0, "hyph/Container/Container.zep", 88);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&argumentDefinitions), _0)
	{
		...
		zephir_array_append(&arguments, &argumentDefinition, PH_SEPARATE, "hyph/Container/Container.zep", 84);
